			...
			<td colspan="2">
				<fieldset>
					<form method="post" action="">
						...
						<input type="submit" name="rating1" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating2" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating3" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating4" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating5" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating6" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating7" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating8" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating9" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
				<fieldset>
					<form method="post" action="">
						...
						<b>Add Rating:</b> <input type="radio" name="raring1"> <input type="radio" name="raring2"> <input type="radio" name="raring3"> <input type="radio" name="raring4"> <input type="radio" name="raring5"> <br> <br> 
						<input type="submit" name="rating10" value="Add" style="margin-left: 6em">
					</form>
				</fieldset>
			</td>
		</tr>
